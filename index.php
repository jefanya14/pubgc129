...
<div class="balance-nom">Iridescence X-Suit</div>
<div class="balance-detail">Exclusive P.D.P Reward</div>
...
<div class="balance-nom">Underworld guide Set</div>
<div class="balance-detail">Exclusive P.D.P Reward</div>
...
<div class="balance-nom">The Fool - M416</div>
<div class="balance-detail">Exclusive P.D.P Reward</div>
...
<div class="balance-nom">Materials: 10</div>
<div class="balance-detail">Exclusive P.D.P Reward</div>
...
<button type="button" onmousedown="buka.play();" class="popup-footer-active" onclick="open_verification()">Collect</button>
</div> <!--- popup-box-item itemShine --->
</div> <!--- popup-box-bg2 --->
